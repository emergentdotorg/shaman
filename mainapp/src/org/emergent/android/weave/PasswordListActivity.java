...
*/
  ...
  protected Bundle createLoaderBundle() {
    ...
    args.putParcelable(LoaderUtil.CONTENT_URI_KEY, Passwords.CONTENT_URI);
    args.putString(LoaderUtil.SORT_ORDER_KEY, Passwords.Columns.HOSTNAME);
    return args;
  }

  @Override
  protected Object createLoaderCallbacks() {
    return LoaderUtil.createPasswordLoaderCallbacks(this);
  }
  ...
  protected SimpleCursorAdapter createCursorAdapter() {
    return LoaderUtil.createPasswordCursorAdapter(this);
  }
