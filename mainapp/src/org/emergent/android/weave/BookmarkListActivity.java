...
public class BookmarkListActivity extends AbstractListActivity {
  ...
  final LinkedList<String> m_parentStack = new LinkedList<String>();
...
*/
  ...
  protected Bundle createLoaderBundle() {
    ...
    args.putCharSequence(LoaderUtil.QUERY_KEY, m_filterString.get());
    args.putParcelable(LoaderUtil.CONTENT_URI_KEY, Bookmarks.CONTENT_URI);
    args.putString(LoaderUtil.SORT_ORDER_KEY, Bookmarks.Columns.TITLE);
    return args;
  }

  @Override
  protected Object createLoaderCallbacks() {
    return LoaderUtil.createBookmarkLoaderCallbacks(this);
  }
  ...
  protected SimpleCursorAdapter createCursorAdapter() {
    return LoaderUtil.createBookmarkCursorAdapter(this);
  }
